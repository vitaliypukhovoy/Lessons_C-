...
namespace Lesson10_linq_query_expression_
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int theBestStudents = (from stud in students
                                   where stud.Average.Average() == 5 && stud.Course == 3
                                   select new { stud.FirstName }).Count();
